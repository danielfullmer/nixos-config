...
color_foreground="${ addSlash base02 }" # Base 02
color_background="${ addSlash base07 }" # Base 07
color_cursor="${ addSlash base02 }" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg ${base02} # forground
  printf $printf_template_custom Ph ${base07} # background
  printf $printf_template_custom Pi ${base02} # bold color
  printf $printf_template_custom Pj ${base05} # selection color
  printf $printf_template_custom Pk ${base02} # selected text color
  printf $printf_template_custom Pl ${base02} # cursor
  printf $printf_template_custom Pm ${base07} # cursor text
else
