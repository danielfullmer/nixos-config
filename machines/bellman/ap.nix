  ...
  services.hostapd = {
    radios = {
      wlo2 = {
        ...
        wifi4 = {
          enable = true;
          capabilities = [ "HT40+" "SHORT-GI-20" "SHORT-GI-40" "DSSS_CCK-40" "MAX-AMSDU-7935" "TX-STBC" "RX-STBC" "LDPC" ];
        };
        wifi5 = {
          enable = true;
          operatingChannelWidth = "80";
          capabilities = [ "MAX-MDPU-11454" "VHT160" "RXLDPC" "SHORT-GI-80" "SHORT-GI-160" "TX-STBC-2BY1" "SU-BEAMFORMEE" "MU-BEAMFORMEE" ];
        };
        wifi6 = {
          enable = true;
          operatingChannelWidth = "80";
